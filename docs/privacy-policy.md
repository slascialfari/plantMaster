...
The app asks for camera access only when you choose to take a photo of a plant. Photos you pick from your library are selected through the system photo picker, which shows the app only the images you choose. Photos are stored on your device and are never uploaded anywhere.

## Deleting your data

Deleting a photo or pin inside the app removes it from the device. Deleting the app removes all of its data.

## Contact

Questions about this policy can be sent to ste.lascialfari@gmail.com.
